        ...
        <div class="col">
            <form method="POST" action="/admin/facilities" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('image.0') is-invalid @enderror" id="image"
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('image.1') is-invalid @enderror" id="image2"
