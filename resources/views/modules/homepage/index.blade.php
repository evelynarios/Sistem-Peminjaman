...
@section('container')
    ...
    <section>
                    ...
                    <div class="card card-body">
                        <div class="dropdown row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="/checkAvailability" method="POST">
                                    ...
                                    <select class="form-select form-select-lg mb-3 col-4" aria-label="Large select example"
                                        name="facility_id" id="facility_id">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="date" class="form-control  form-select-lg mb-3 col-4" name="tanggalSewa"
                                    id="tanggalSewa" required>
                                <button class="btn" type="submit"
                                    style="background-color: #03045e; color: #fff;border-color: #03045e;">Submit</button>
                            </div>
                            </form>
                            {{-- COBA --}}
                        </div>
                ...
                <div class="collapse" id="multiCollapseExample3" style="width :100%">
                    <div class=" card card-body">
                        <div class="dropdown row">
                            ...
                            <div class="col-lg-6">
                                <p class="fs-1">Tanggal</p>
                                <input type="date" id="tanggalSewa" name="tanggalSewa"
                                    class="form-control  form-select-lg mb-3 col-4">
                                <button class="btn" type="submit"
                                    style="background-color: #03045e; color: #fff;border-color: #03045e;">Submit</button>
                            </div>
                            </form>
        ...
        <div class="row">
            <h1 class="text-center fs-2  mb-4" style="color: #03045e; padding-top: 100px;">About Fasilitas UNIB </h1>
        </div>

        <!-- acordion for about Sistem -->
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <strong>Apa saja Fasilitas UNIB ?</strong>
                        </button>
                    </h2>
